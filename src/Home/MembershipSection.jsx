...
export default function MembershipSection() {
  ...
  // Replace these placeholder URLs with your imported logos: logo1, logo2, etc.
 // Logo data with names for fallback display
  const topRowLogos = [
   { name: 'BCGPT', url: logo1 },
   { name: 'BCGPT', url: logo2 },
   { name: 'BCGPT', url: logo3 },
   { name: 'BCGPT', url: logo4 }
  ];

  const bottomRowLogos = [
   { name: 'BCGPT', url: logo5 },
   { name: 'BCGPT', url: logo6 },
   { name: 'BCGPT', url: logo7 }
  ];
  useEffect(() => {
