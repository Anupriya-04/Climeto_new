...
export default function BrandsTrust() {
  ...
  // Replace these placeholder logos with your actual imported images
  // When integrating, import your images at the top and use them here:
  // import img1 from "../assets/images/img1.png";
  // import img2 from "../assets/images/img2.png";
  // ... etc
  ...
  const renderRow = (logos, animationDirection, delay = 0) => {
    // Calculate animation duration based on number of logos to maintain consistent speed
    const baseSpeed = 40; // pixels per second
    const logoWidth = isMobile ? 100 : isTablet ? 140 : 180; // approximate width including gap
  ...
  return (
    <>
      ...
      >
        ...
        {renderRow(logosRow1, 'scrollLeft', 0)}
        {renderRow(logosRow2, 'scrollLeft', 0)}
        {renderRow(logosRow3, 'scrollLeft', 0)}
      </section>
    </>
  );
}