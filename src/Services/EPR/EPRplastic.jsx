...
export default function EPRPlasticPage() {
  ...
  return (
    <div style={{ width: '100%', backgroundColor: '#ffffff' }}>
      {/* Hero Section */}
      <section style={{
        backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=1920&h=800&fit=crop&q=80)',
