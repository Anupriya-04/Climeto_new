...
export default function EPRBatteryPage() {
  ...
  return (
    <div style={{ width: '100%', backgroundColor: '#ffffff' }}>
      {/* Hero Section */}
      <section style={{
        backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=1920&h=800&fit=crop&q=80)',
